...
export function buildPlanningPrompt(
  ...
  return [
    ...
    "- For momentum comparisons across tokens, include get_market_overview plus get_token_profile/get_token_erc20/get_token_transfers and get_token_history for each compared token.",
    ...
    "- When the user asks about N tokens, emit get_token_profile/get_token_erc20/get_token_transfers (and optionally get_token_holders) plus get_token_history for each of the N tokens individually.",
